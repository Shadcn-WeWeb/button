...
.ww-button.icon-only .button-icon {
    width: 1.25rem;
    height: 1.25rem;
}

/* Responsive des icônes selon la taille */
.ww-button.size-sm .button-icon {
    width: 0.875rem;
    height: 0.875rem;
}

.ww-button.size-lg .button-icon {
    width: 1.125rem;
    height: 1.125rem;
}

.ww-button.size-sm.icon-only .button-icon {
    width: 1rem;
    height: 1rem;
}

.ww-button.size-lg.icon-only .button-icon {
    width: 1.5rem;
    height: 1.5rem;
}
</style>